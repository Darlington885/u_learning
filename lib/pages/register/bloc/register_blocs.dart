...
class RegisterBlocs extends Bloc<RegisterEvent, RegisterStates>{
     RegisterBlocs(): super(const RegisterStates()) {
      ...
      /// The copyWith method creates a new object e.g in the
     /// textfield while typing a new letter is been added to the previously typed letter
     /// copyWith([]) - This is called positional parameter
